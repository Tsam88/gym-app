...
/*!********************************************************!*\
  !*** ./resources/js/vue-simple-search-dropdown.min.js ***!
  \********************************************************/
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }

window["Dropdown"] = function (t) {
  var e = {};
  ...
  r.t = function (t, e) {
    ...
    if (e & 2 && typeof t != "string") for (var o in t) {
      r.d(n, o, function (e) {
        return t[e];
      }.bind(null, o));
    }
  ...
  var n = r(31);
  if (typeof n === "string") n = [[t.i, n, ""]];
  if (n.locals) t.exports = n.locals;
  var o = r(29)["default"];
  var i = o("0bcda724", n, false, {});
  ...
  e["default"] = {
    ...
    computed: {
      filteredOptions: function t() {
        var e = [];
        var r = new RegExp(this.searchFilter, "ig");
        var n = true;
        var i = false;
        var a = undefined;

        try {
          for (var u = (0, o["default"])(this.options), s; !(n = (s = u.next()).done); n = true) {
            var f = s.value;

            if (this.searchFilter.length < 1 || f.name.match(r)) {
              if (e.length < 100) e.push(f);
            }
          }
        } catch (t) {
          i = true;
  ...
  var n = function n() {
    ...
    var r = t._self._c || e;
    return t.options ? r("div", {
      staticClass: "dropdown"
    }, [r("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: t.searchFilter,
      ...
      directives: [{
        name: "show",
        rawName: "v-show",
        value: t.optionsShown,
        expression: "optionsShown"
      }],
      staticClass: "dropdown-content"
    }, t._l(t.filteredOptions, function (e) {
      return r("div", {
  ...
  t.exports = function (t, e, r) {
    if (t && !o(t = r ? t : t.prototype, i)) n(t, i, {
      configurable: true,
      value: e
    });
  };
  ...
  t.exports = function (t, e, r, m, g, x, w) {
    s(r, e, m);
    ...
    var M = j[l] || j[d] || g && j[g];
    var C = M || b(g);
    var T = g ? !S ? C : b("entries") : undefined;
    var L = e == "Array" ? j.entries || M : M;
    var k, P, E;

    if (L) {
      E = c(L.call(new t()));

      if (E !== Object.prototype && E.next) {
        f(E, _, true);
        if (!n && typeof E[l] != "function") a(E, l, y);
      }
    }
  ...
  function m(t) {
    ...
    if (d) {
      var o = s++;
      n = u || (u = y());
      e = x.bind(null, n, o, false);
      r = x.bind(null, n, o, true);
    } else {
      n = y();
      e = w.bind(null, n);
  ...
  t.exports = function (t) {
    ...
    e.i = function (t, r) {
      ...
      for (var o = 0; o < this.length; o++) {
        var i = this[o][0];
        if (typeof i === "number") n[i] = true;
      }

      for (o = 0; o < t.length; o++) {
        var a = t[o];

        if (typeof a[0] !== "number" || !n[a[0]]) {
          if (r && !a[2]) {
            a[2] = r;
          } else if (r) {
            a[2] = "(" + a[2] + ") and (" + r + ")";
  ...
  function r(t, e) {
    ...
    if (e && typeof btoa === "function") {
      var i = n(o);
      var a = o.sources.map(function (t) {
  ...
  function n(t) {
    ...
    var r = "sourceMappingURL=data:application/json;charset=utf-8;base64," + e;
    return "/*# " + r + " */";
  }
}, function (t, e, r) {
  e = t.exports = r(30)(false);
  ...
  t.exports = function (t) {
    var e, r, u;
    return t === undefined ? "Undefined" : t === null ? "Null" : typeof (r = a(e = Object(t), o)) == "string" ? r : i ? n(e) : (u = n(e)) == "Object" && typeof e.callee == "function" ? "Arguments" : u;
  };
}, function (t, e, r) {
  var n = r(33);
  var o = r(0)("iterator");
  ...
  t.exports = r(6).getIteratorMethod = function (t) {
    if (t != undefined) return t[o] || t["@@iterator"] || i[n(t)];
  };
}, function (t, e, r) {
  var n = r(5);
  var o = r(34);
  ...
  t.exports = function (t) {
    return function (e, r) {
      ...
      s = i.charCodeAt(a);
      return s < 55296 || s > 56319 || a + 1 === u || (f = i.charCodeAt(a + 1)) < 56320 || f > 57343 ? t ? i.charAt(a) : s : t ? i.slice(a, a + 2) : (s - 55296 << 10) + (f - 56320) + 65536;
    };
  };
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = !r(4) && !r(24)(function () {
    return Object.defineProperty(r(23)("div"), "a", {
      get: function get() {
        return 7;
      }
    }).a != 7;
  ...
  var f = function f(t, e, r) {
    ...
    for (x in r) {
      ...
      if (w && u(y, x)) continue;
      b = w ? g[x] : r[x];
      y[x] = l && typeof g[x] != "function" ? r[x] : p && w ? i(b, n) : h && g[x] == b ? function (t) {
        ...
        e[s] = t[s];
        return e;
      }(b) : d && typeof b == "function" ? i(Function.call, b) : b;

      if (d) {
        (y.virtual || (y.virtual = {}))[x] = b;
        if (t & f.R && m && !m[x]) a(m, x, b);
      }
    }
  };
  ...
  t.exports = r(26)(Array, "Array", function (t, e) {
    ...
    if (e == "keys") return o(0, r);
    if (e == "values") return o(0, t[r]);
    return o(0, [r, t[r]]);
  }, "values");
  i.Arguments = i.Array;
  n("keys");
  ...
  var a = r(32);
  var u = r(28);
  var s = Object(u["a"])(o["default"], n["a"], n["b"], false, null, "4e520537", null);

  if (false) { var f; }

  s.options.__file = "src\\Dropdown.vue";
  e["default"] = s.exports;
}, function (t, e, r) {
  "use strict";
  ...
  t.exports = {
    install: function t(e, r) {
      e.component("Dropdown", o["default"]);
    }
  };
}]);
/******/ })()
